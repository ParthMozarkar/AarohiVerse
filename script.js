...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateCountdown() {
    ...
    if (distance <= 0) {
      ...
      btnText.innerHTML = "Enter Piyuverse";
      ...
      button.onclick = () => {
        ...
        // 1. Show Overlay INSTANTLY to kill the white flash
        overlay.classList.add("active");
        gate.classList.add("warp-out");

        // 2. Start Fake Progress for Hype
        let progress = 0;
        ...
        // 3. Set music state and redirect
        setTimeout(() => {
...
>>>>>>> 6c4b6cd2cb56615b74cc0cf362400693e8efe4bf
